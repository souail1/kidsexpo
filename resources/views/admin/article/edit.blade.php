...
@section("content")
	<form class="layui-form layui-form-pane" style="width:60%;">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="cate" lay-filter="cate">
					<option value=''>{{$article['cate']}}</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="title" lay-verify="required" value="{{$article['title']}}">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">内容</label>
			<textarea id="content" style="display: none;" value="{{$article['content']}}"></textarea>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">是否发布</label>
			<div class="layui-input-block">
				<input type="checkbox" value="1" checked="" name="status" lay-skin="switch" lay-filter="switchTest" lay-text="是|否">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
